...
A good example to distinguish substitute and quote would be to use them for getting labels for x-axis and y-axis in the myplot function as shown below.
